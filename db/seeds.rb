...
Group.create(name: 'Eng-01', stream: 'Technical', startdate: '01-07-2017', enddate: '01-10-2017', active: false)
Group.create(name: 'Eng-07', stream: 'Technical', startdate: '10-10-2017', enddate: '10-02-2018', active: false)
Group.create(name: 'Eng-09', stream: 'Technical', startdate: '23-04-2018', enddate: '12-08-2018', active: false)
Group.create(name: 'Eng-11', stream: 'Technical', startdate: '24-08-2018', enddate: '12-11-2018', active: true)
Group.create(name: 'Eng-13', stream: 'Technical', startdate: '30-09-2018', enddate: '17-12-2018', active: true)
Group.create(name: 'Eng-16', stream: 'Technical', startdate: '09-10-2018', enddate: '12-03-2019', active: true)
...
Student.create(name: 'BK', active: true, group_id: 1)
